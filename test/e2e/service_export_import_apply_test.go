...
func TestServiceExport(t *testing.T) {
	...
	test.ServiceUpdateWithOptions(r, "hello", "--env", "a=mouse", "--revision-name", "rev2", "--no-lock-to-digest")
	serviceExport(r, "hello", getServiceWithOptions(
		withServiceName("hello"),
	...
	test.ServiceUpdateWithOptions(r, "hello", "--tag", "hello-rev1=candidate", "--traffic", "candidate=2%,@latest=98%")
	...
	test.ServiceUpdateWithOptions(r, "hello", "--untag", "candidate")
	test.ServiceUpdateWithOptions(r, "hello", "--env", "b=cat", "--revision-name", "hello-rev3", "--traffic", "hello-rev1=30,hello-rev2=30,hello-rev3=40")
	...
	test.ServiceUpdateWithOptions(r, "hello", "--traffic", "hello-rev2=100")
