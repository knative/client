...
| https://github.com/knative/client/pull/966[#966] (backport)
...
| https://github.com/knative/client/pull/948[#948] (backport)

| 🎁
| Add support for internal plugins (backport)
| https://github.com/knative/client/pull/991[#991]
|===
