...
var apiVersions = map[string][]string{
	...
	"eventing": {
		"sources.knative.dev/v1alpha1 (knative-eventing v0.14.0)",
		"sources.knative.dev/v1alpha2 (knative-eventing v0.14.0)",
		"eventing.knative.dev/v1alpha1 (knative-eventing v0.14.0)",
	},
}
