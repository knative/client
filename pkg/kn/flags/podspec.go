...
func (p *PodSpecFlags) AddFlags(flagset *pflag.FlagSet, generalFlagSet, experimentalFlagSet *pflag.FlagSet) []string {
	...
	experimentalFlagSet.StringArrayVar(&p.NodeSelector, "node-selector", []string{}, "Add node selector to be set, you may provide this flag any number of times to set multiple node selectors, "+
	...
	experimentalFlagSet.StringSliceVar(&p.Toleration, "toleration", []string{},
	...
	experimentalFlagSet.StringSliceVar(&p.NodeAffinity, "node-affinity", []string{},
