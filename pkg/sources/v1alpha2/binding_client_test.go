...
func TestDeleteSinkBinding(t *testing.T) {
	...
	err := client.DeleteSinkBinding(context.Background(), name)
	assert.NilError(t, err)

	err = client.DeleteSinkBinding(context.Background(), "errorSinkBinding")
...
func TestCreateSinkBinding(t *testing.T) {
	...
	t.Run("create binding without error", func(t *testing.T) {
		err := client.CreateSinkBinding(context.Background(), objNew)
		assert.NilError(t, err)
	})

	t.Run("create binding with an error returns an error object", func(t *testing.T) {
		err := client.CreateSinkBinding(context.Background(), newSinkBinding("unknown", "mysvc", "mypings"))
...
func TestGetSinkBinding(t *testing.T) {
	...
	binding, err := client.GetSinkBinding(context.Background(), name)
	assert.NilError(t, err)
	...
	_, err = client.GetSinkBinding(context.Background(), "errorSinkBinding")
	assert.ErrorContains(t, err, "errorSinkBinding")
}
