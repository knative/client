...
func (c *pingSourcesClient) CreatePingSource(pingsource *v1alpha2.PingSource) error {
	...
	_, err := c.client.Create(context.Background(), pingsource, metav1.CreateOptions{})
	return err
}

func (c *pingSourcesClient) UpdatePingSource(pingSource *v1alpha2.PingSource) error {
	_, err := c.client.Update(context.Background(), pingSource, metav1.UpdateOptions{})
	return err
}

func (c *pingSourcesClient) DeletePingSource(name string) error {
	return c.client.Delete(context.Background(), name, metav1.DeleteOptions{})
}

func (c *pingSourcesClient) GetPingSource(name string) (*v1alpha2.PingSource, error) {
	return c.client.Get(context.Background(), name, metav1.GetOptions{})
}
