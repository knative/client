...
func TestMockKnClient(t *testing.T) {
	...
	// Call all services
	client.GetService(context.Background(), "hello")
	client.ListServices(context.Background(), WithName("blub"))
	client.ListServices(context.Background(), WithLabel("foo", "bar"))
	client.CreateService(context.Background(), &servingv1.Service{})
	client.UpdateService(context.Background(), &servingv1.Service{})
	client.ApplyService(context.Background(), &servingv1.Service{})
	client.DeleteService(context.Background(), "hello", time.Duration(10)*time.Second)
	client.WaitForService(context.Background(), "hello", time.Duration(10)*time.Second, wait.NoopMessageCallback())
	client.GetRevision(context.Background(), "hello")
	client.ListRevisions(context.Background(), WithName("blub"))
	client.CreateRevision(context.Background(), &servingv1.Revision{})
	client.UpdateRevision(context.Background(), &servingv1.Revision{})
	client.DeleteRevision(context.Background(), "hello", time.Duration(10)*time.Second)
	client.GetRoute(context.Background(), "hello")
	client.ListRoutes(context.Background(), WithName("blub"))
	client.GetConfiguration(context.Background(), "hello")
