...
func (cl *knServingClient) GetService(name string) (*servingv1.Service, error) {
	service, err := cl.client.Services(cl.namespace).Get(context.Background(), name, v1.GetOptions{})
	if err != nil {
...
func (cl *knServingClient) ListServices(config ...ListConfig) (*servingv1.ServiceList, error) {
	serviceList, err := cl.client.Services(cl.namespace).List(context.Background(), ListConfigs(config).toListOptions())
	if err != nil {
		return nil, clienterrors.GetError(err)
	}
...
func (cl *knServingClient) CreateService(service *servingv1.Service) error {
	_, err := cl.client.Services(cl.namespace).Create(context.Background(), service, v1.CreateOptions{})
	if err != nil {
...
func (cl *knServingClient) UpdateService(service *servingv1.Service) error {
	_, err := cl.client.Services(cl.namespace).Update(context.Background(), service, v1.UpdateOptions{})
	if err != nil {
		return err
	}
	return updateServingGvk(service)
...
func (cl *knServingClient) GetConfiguration(name string) (*servingv1.Configuration, error) {
	configuration, err := cl.client.Configurations(cl.namespace).Get(context.Background(), name, v1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func (cl *knServingClient) GetRevision(name string) (*servingv1.Revision, error) {
	revision, err := cl.client.Revisions(cl.namespace).Get(context.Background(), name, v1.GetOptions{})
	if err != nil {
		return nil, clienterrors.GetError(err)
	}
...
func (cl *knServingClient) deleteRevision(name string) error {
	err := cl.client.Revisions(cl.namespace).Delete(context.Background(), name, v1.DeleteOptions{})
	if err != nil {
		return clienterrors.GetError(err)
	}
...
func (cl *knServingClient) ListRevisions(config ...ListConfig) (*servingv1.RevisionList, error) {
	revisionList, err := cl.client.Revisions(cl.namespace).List(context.Background(), ListConfigs(config).toListOptions())
	if err != nil {
		return nil, clienterrors.GetError(err)
	}
...
func (cl *knServingClient) GetRoute(name string) (*servingv1.Route, error) {
	route, err := cl.client.Routes(cl.namespace).Get(context.Background(), name, v1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func (cl *knServingClient) ListRoutes(config ...ListConfig) (*servingv1.RouteList, error) {
	routeList, err := cl.client.Routes(cl.namespace).List(context.Background(), ListConfigs(config).toListOptions())
	if err != nil {
		return nil, err
	}
